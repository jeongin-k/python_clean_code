...
class LightControllerTest(unittest.TestCase):
    ...
    def test_removed_light_does_nothing(self):
        ...
        self.assertEqual(LightState.UNKNOWN.value, SpyLightDriver.get_state(1))
        self.light_controller.turn_off(1)
        self.assertEqual(LightState.UNKNOWN.value, SpyLightDriver.get_state(1))
